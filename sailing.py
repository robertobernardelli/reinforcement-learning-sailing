...
class SailingEnv(gym.Env):
    ...
    def render(self):
        ...
        self.img = draw_sea_and_dashboard(self.wind_direction, self.boat_heading, 
                                          self.boat_speed, self.total_reward)
    ...
    def step(self, action):
        ...
        #get boat speed
        self.boat_speed = get_boat_speed(self.boat_heading, self.wind_direction, self.tck)
        ...
        euclidean_dist_to_target = np.linalg.norm(np.array(self.boat_position) - np.array(self.target_position))

        self.total_reward = ((250 - euclidean_dist_to_target) + target_reward - 2*self.time)/100
        ...
        # create observation:
        observation = [boat_position_x, boat_position_y, target_delta_x, target_delta_y, self.boat_heading]
